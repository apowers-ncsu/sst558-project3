...
We need to factor many of these fields. I also like to change doubles to integers for appropriate numeric fields.

#### Converting factors

I need to factor the following fields. First, I'll take care of binary ones and leave out the labels. Then, there are a few with multiple categories to encode, where I will include labels.
...
lapply(X=data[factor_fields],FUN=as.factor,labels=c(FALSE,TRUE))
