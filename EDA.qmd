...
This project explores a dataset, develops models for it, and provides an API interface for on-demand model results.

## Dataset

I am studying data on diabetes health indicators, pulled from Kaggle. The following summaries are from the [dataset source page](https://www.kaggle.com/datasets/alexteboul/diabetes-health-indicators-dataset/):
