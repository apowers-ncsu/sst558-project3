...
g <- data |>
  ...
  labs(
    title="BMI Histogram with Diabetes state",
  ) +
  geom_density(
    alpha=0.5
    #bindwidth=11
...
I think many of the predictors may relate to the response variable here. So, I'll proceed to some modeling to understand 
